		...
		return $this->render(array('json' => array('success'=>1,
			...
			'result'=>array(
				array(
					...
					'Volume'=> array(
						number_format($jdecBU->VolumeFirst,2). " BTC",								
						number_format($jdecBU->VolumeSecond,2). " USD"
						),
					'FirstUnit'=> 'BTC',			
					'SecondUnit'=> 'USD',
				),
				array(
					...
					'Volume'=> array(
						number_format($jdecBG->VolumeFirst,2). " BTC",								
						number_format($jdecBG->VolumeSecond,2). " GBP"
						),
					'FirstUnit'=> 'BTC',			
					'SecondUnit'=> 'GBP',
				),
				array(
					...
					'Volume'=> array(
						number_format($jdecBE->VolumeFirst,2). " BTC",								
						number_format($jdecBE->VolumeSecond,2). " EUR"
						),
					'FirstUnit'=> 'BTC',			
					'SecondUnit'=> 'EUR',
				),
				array(
					'Low'=> number_format($jdecXU->Low,2),
					'High' => number_format($jdecXU->High,2),
					'Last'=> number_format($jdecXU->Last,2),			
					'Volume'=> array(
						number_format($jdecXU->VolumeFirst,2). " XGC",								
						number_format($jdecXU->VolumeSecond,2). " USD"
						),
					'FirstUnit'=> 'XGC',			
					'SecondUnit'=> 'USD',
				),
				array(
					'Low'=> number_format($jdecXG->Low,2),
					'High' => number_format($jdecXG->High,2),
					'Last'=> number_format($jdecXG->Last,2),			
					'Volume'=> array(
						number_format($jdecXG->VolumeFirst,2). " XGC",								
						number_format($jdecXG->VolumeSecond,2). " GBP"
						),
					'FirstUnit'=> 'XGC',			
					'SecondUnit'=> 'GBP',
				),
				array(
					'Low'=> number_format($jdecXE->Low,2),
					'High' => number_format($jdecXE->High,2),
					'Last'=> number_format($jdecXE->Last,2),			
					'Volume'=> array(
						number_format($jdecXE->VolumeFirst,2). " XGC",								
						number_format($jdecXE->VolumeSecond,2). " EUR"
						),
					'FirstUnit'=> 'XGC',			
					'SecondUnit'=> 'EUR',
				),
array(
					'Low'=> number_format($jdecBX->Low,2),
					'High' => number_format($jdecBX->High,2),
					'Last'=> number_format($jdecBX->Last,2),			
					'Volume'=> array(
						number_format($jdecBX->VolumeFirst,2). " BTC",								
						number_format($jdecBX->VolumeSecond,2). " XGC"
						),
					'FirstUnit'=> 'BTC',			
					'SecondUnit'=> 'XGC',
				),				
